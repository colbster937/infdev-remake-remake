...
public class PlayerControllerSP extends PlayerController {
  ...
  new SpawnerMonsters(this, 100, EntityMonster.class, new String[] { "Zombie", "Skeleton", "Creeper", "Spider" });

	private SpawnerAnimals animalSpawner = new SpawnerAnimals(20, EntityAnimal.class, new String[] { "Sheep", "Pig" });
