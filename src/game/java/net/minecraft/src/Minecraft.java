...
public class Minecraft implements Runnable {
	...
	public Minecraft() {
		...
		this.tempDisplayWidth = w;
		this.tempDisplayHeight = h;
		this.displayWidth = w;
	...
	private void loadScreen() throws LWJGLException {
		...
		var4.addVertexWithUV(0.0D, (double) this.displayHeight, 0.0D, 0.0D,
				(double) ((float) this.displayHeight / var5 + 0.0F));
		var4.addVertexWithUV((double) this.displayWidth, (double) this.displayHeight, 0.0D,
				(double) ((float) this.displayWidth / var5), (double) ((float) this.displayHeight / var5 + 0.0F));
	...
	private void displayDebugInfo() {
		...
		for (int var7 = 0; var7 < tickTimes.length; ++var7) {
			...
			var3.addVertex((double) ((float) var7 + 0.5F), (double) ((float) ((long) this.displayHeight - var11) + 0.5F),
					0.0D);
									...
									while (true) {
										do {
											if (!Keyboard.next()) {
												...
												this.sendClickBlockToController(0,
														this.currentScreen == null && Mouse.isButtonDown(0) && this.inGameHasFocus);
												break label226;
											}
										...
										if (Keyboard.getEventKey() == Keyboard.KEY_F11) {
											...
											if (this.currentScreen != null) {
												...
												if (Keyboard.getEventKey() == this.gameSettings.keyBindDrop.keyCode) {
													this.thePlayer.dropPlayerItemWithRandomChoice(
															this.thePlayer.inventory.decrStackSize(this.thePlayer.inventory.currentItem, 1), false);
												}
											}
											...
											if (Keyboard.getEventKey() == this.gameSettings.keyBindToggleFog.keyCode) {
												this.gameSettings.setOptionFloatValue(4,
														!Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) && !Keyboard.isKeyDown(Keyboard.KEY_RSHIFT) ? 1
																: -1);
											}
										}
									}
