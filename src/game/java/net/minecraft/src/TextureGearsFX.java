...
public class TextureGearsFX extends TextureFX {
	...
	public TextureGearsFX(int var1) {
		...
		ImageData var2 = ImageData.loadImageFile(EagRuntime.getResourceStream("/misc/gear.png"));
		var2.getRGB(0, 0, 32, 32, this.gearColor, 0, 32);
		var2 = ImageData.loadImageFile(EagRuntime.getResourceStream("/misc/gearmiddle.png"));
